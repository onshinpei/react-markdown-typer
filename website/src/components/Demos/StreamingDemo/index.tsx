...
const StreamingDemo: React.FC<DemoProps> = ({ markdown }) => {
  ...
  const streamingData: Record<StreamingType, StreamingItem[]> = {
    ...
    'code-generation': [
      ...
      { content: "import ReactMarkdownTyper from 'react-markdown-typer';\n\n", type: 'answer' },
      ...
      { content: '        <ReactMarkdownTyper key={index} interval={20}>\n', type: 'answer' },
      { content: '          {msg}\n', type: 'answer' },
      { content: '        </ReactMarkdownTyper>\n', type: 'answer' },
      { content: '      ))}\n', type: 'answer' },
      { content: '    </div>\n', type: 'answer' },
      { content: '  );\n', type: 'answer' },
      { content: '}\n', type: 'answer' },
    ...
    documentation: [
      ...
      { content: '  return (\n', type: 'answer' },
      { content: '    <ReactMarkdownTyper interval={20}>\n', type: 'answer' },
      { content: '      # Hello World\n', type: 'answer' },
